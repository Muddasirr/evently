...
const Dropdown = ( {value,onChangeHandler}:DropdownProps) => {
  ...
  <SelectContent>
    ...
    <AlertDialog>
  <AlertDialogTrigger className="p-medium-14 flex w-full rounder-sm py-3
   pl-8 text-primary-500 hover:bg-primary-50 focus:text-primary-500">Add New Category</AlertDialogTrigger>
